...
//      var frame = self.frame
  ...
  public func image2(scale: CGFloat = 1.0) -> UIImage? {
    //Autoreleasepool helps to read debug out, remove it later for tests
    return autoreleasepool { () -> UIImage? in
      ...
      /*** IP 5s Max iOS 12.X
       ...
       Additional Problematic... passing 1x but dont know if its full screen / what screen resolution is used...
       so on iphone 5s with 640x1136 => 1280*2272  => 1786.0, 2665.0 the rendering is slightly too height
       i
